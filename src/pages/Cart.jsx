...
const Cart = () => {
  ...
  useEffect(() => {
    setTotalAmount(cart.reduce((acc, curr) => acc + curr.price, 0)); // acc = accumulator
  }, [cart]);

  return (
    <div className="mb-10 px-4">
      {cart.length > 0 ? (
        <div className="flex flex-col lg:flex-row justify-center max-w-[1300px] mx-auto gap-x-5">
          {/* Cart Item */}
          ...
          {/* Summary */}
          <div className="w-full lg:w-[40%] mt-5 flex flex-col">
            <div className="flex flex-col h-full justify-between p-5 gap-5 my-14 bg-white rounded-lg shadow-lg">
